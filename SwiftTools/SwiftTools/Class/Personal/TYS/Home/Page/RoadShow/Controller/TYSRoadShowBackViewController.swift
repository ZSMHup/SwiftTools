//
//  TYSRoadShowBackViewController.swift
//  SwiftTools
//
...
class TYSRoadShowBackViewController: BaseViewController {
...
extension TYSRoadShowBackViewController {
...
// MARK: delegate
extension TYSRoadShowBackViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, insetForSectionAt section: Int) -> UIEdgeInsets{
        return UIEdgeInsetsMake(AdaptW(w: 24), AdaptW(w: 24), 0, AdaptW(w: 24))
    }
